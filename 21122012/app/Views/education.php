...
<header>
    ...
    <div class="heroe">
        ...
        <h1>My Education</h1>
        <table Border=2 cellspacing=2 bgcolor="grey" style="width:100%">
        <tr>
            <th>Tingkat</th>
            <th>Nama Sekolah</th>
        </tr>
        <tr>
            <td>TK</td>
            <td>TK Al-Quran Al-Azhar</td>
        </tr>
        <tr>
            <td>SD</td>
            <td>SDN GENTRA MASEKDAS</td>
        </tr>
        <tr>
            <td>SMP</td>
            <td>SMP DEWI SARTIKA</td>
        </tr>
        <tr>
            <td>SMK</td>
            <td>SMKN 3 BANDUNG</td>
        </tr>
    </table>
